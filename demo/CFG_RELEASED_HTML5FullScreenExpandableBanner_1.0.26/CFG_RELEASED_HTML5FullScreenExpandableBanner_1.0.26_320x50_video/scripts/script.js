...
{
	var bannerSize = (EB._adConfig && EB._adConfig.hasOwnProperty("mdBannerSizeInheritance") && EB._adConfig.mdBannerSizeInheritance === "browserWidth" ? "Full Width" : window.innerWidth) + " x " + window.innerHeight + " (video)";
	document.getElementById("banner").childNodes[1].innerHTML = "<strong>HTML5 Full Screen Expandable Banner:</strong> " + bannerSize;
}
